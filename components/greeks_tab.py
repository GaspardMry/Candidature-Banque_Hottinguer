...
def render(df: pd.DataFrame):
    ...
    info_box(
        "Explications :",
        "Les <b>Greeks</b> mesurent en règle générale la sensibilité du prix d'une option à différents facteurs. "
    ...
    with col1:
        ...
        fig_delta.update_xaxes(title="Heures de travail / semaine")
    ...
    with col1:
        ...
        fig_gamma.update_xaxes(title="Heures de travail / semaine")
        fig_gamma.update_yaxes(title="Gamma (accélération)")
    ...
    with col2:
        ...
        info_box(
            ...
            f"c'est la <b>zone d'accélération Hyperfocus</b>. "
    ...
    with col1:
        ...
        fig_vega.update_xaxes(title="Volatilité du marché (offres de stage)")
    ...
    with col1:
        ...
        fig_theta.update_xaxes(title="Jours d'inaction")
        fig_theta.update_yaxes(tickformat=".0%", title="Probabilité résiduelle")
    ...
    st.markdown("---")
    info_box(
        "Résultats des Greeks sur mon profil :",
        "<b>Delta élevé</b> → l'effort paie, et je le sais. "
        "<b>Gamma positif (zone Hyperfocus)</b> → l'accélération est intégrée, pas linéaire. "
        "<b>Vega positif</b> → je suis antifragile face à l'incertitude du marché. "
        "<b>Theta négatif</b> → je ne peux pas me permettre de ne rien faire. "
        "Ce profil de sensibilités est celui d'un <b>call option deep Out-Of-The-Money</b> "
        "avec un potentiel de hausse asymétrique.",
        style="orange",
    )
