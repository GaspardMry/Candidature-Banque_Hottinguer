...
METRIC_COLORS = {
    ...
    "Probabilité_Neuro": COLORS["purple"],
    "Probabilité_Ecole_NonTarget": COLORS["green"],
}

METRIC_LABELS = {
    "Probabilité_Village": "Village → Risk Analyst",
    "Probabilité_BAC_1025": "BAC 10.25 → Finance de marché",
    "Probabilité_Neuro": "Neurodivergent → Performance",
    "Probabilité_Ecole_NonTarget": "Non-Target → Stage Risk Analyst",
}
...
def get_plotly_layout(title="", height=450):
    ...
    return go.Layout(
        title=dict(
            text=title,
            font=dict(color=COLORS["white"], size=16, family="Courier New"),
            x=0.01,
        ),
        paper_bgcolor=COLORS["bg_card"],
        plot_bgcolor=COLORS["bg"],
        font=dict(color=COLORS["orange"], family="Courier New", size=12),
        height=height,
